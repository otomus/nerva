...
1. **Install Nerva**
   ...
   <Aside type="tip">
   Nerva has zero required dependencies beyond the standard library. Optional extras like `nerva[native]` add Rust-accelerated hot paths for memory and matching.
   </Aside>
